...
class RequestingOrderTimeThirdWidget extends StatefulWidget {
  Order order;
  RequestingOrderTimeThirdWidget({Key? key,required this.order}) : super(key: key);

  @override
  State<RequestingOrderTimeThirdWidget> createState() => _RequestingOrderTimeThirdWidgetState();
}

class _RequestingOrderTimeThirdWidgetState extends State<RequestingOrderTimeThirdWidget> {
  @override
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 15,),
              Column(
                children: List.generate(widget.order.buildings!.length, (index){
                  return SizedBox(
                      width: MediaQuery.of(context).size.width,
                      child: RichText(
                        text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                  text: widget.order.buildings?[index],
                                  style: const TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w400,
                                      fontFamily: 'Tajawal',
